...
@dataclass
class TextBlock:
    """Minimal text block used by memory tool responses."""
...
@dataclass
class ToolResponse:
    """Minimal tool response compatible with generated agent usage."""
...
class StateModule:
    """Small state helper for backend memory classes."""
