...
@dataclass
class CodeAgentAgentConfig:
    """CodeAgentAgent 的运行参数。"""

    prompt_file: str = "code_agent_agent.md"
...
class CodeAgentAgent(BaseAgent):
    """
    负责"code_agent"的 agent。
    ...
    def __init__(
        ...
        config: Optional[CodeAgentAgentConfig] = None,
        prompt_loader: Optional[PromptLoader] = None,
    ) -> None:
        super().__init__(
            agent_type="code_agent",
            model=model,
            config=config or CodeAgentAgentConfig(),
