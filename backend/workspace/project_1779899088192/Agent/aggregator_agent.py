...
@dataclass
class AggregatorAgentConfig:
    """AggregatorAgent 的运行参数。"""

    prompt_file: str = "aggregator_agent.md"
...
class AggregatorAgent(BaseAgent):
    ...
    def __init__(
        ...
        config: Optional[AggregatorAgentConfig] = None,
        prompt_loader: Optional[PromptLoader] = None,
    ) -> None:
        super().__init__(
            agent_type="aggregator",
            model=model,
            config=config or AggregatorAgentConfig(),
