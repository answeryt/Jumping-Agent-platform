...
@dataclass
class TaskSplitAgentConfig:
    """TaskSplitAgent 的运行参数。"""

    prompt_file: str = "task_split_agent.md"
...
class TaskSplitAgent(BaseAgent):
    """
    负责"task_split"的 agent。
    ...
    def __init__(
        ...
        config: Optional[TaskSplitAgentConfig] = None,
        prompt_loader: Optional[PromptLoader] = None,
    ) -> None:
        super().__init__(
            agent_type="task_split",
            model=model,
            config=config or TaskSplitAgentConfig(),
