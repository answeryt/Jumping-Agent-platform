...
class RequirementsAgentConfig:
    """RequirementsAgent 的运行参数。"""

    prompt_file: str = "requirements_agent.md"
...
class RequirementsAgent(BaseAgent):
    ...
    def __init__(
        ...
        config: Optional[RequirementsAgentConfig] = None,
        prompt_loader: Optional[PromptLoader] = None,
    ) -> None:
        super().__init__(
            agent_type="requirements",
            model=model,
            config=config or RequirementsAgentConfig(),
