...
@dataclass
class TechBranchAgentConfig:
    """TechBranchAgent 的运行参数。"""

    prompt_file: str = "tech_branch_agent.md"
...
class TechBranchAgent(BaseAgent):
    """
    负责"tech_branch"的 agent。
    ...
    def __init__(
        ...
        config: Optional[TechBranchAgentConfig] = None,
        prompt_loader: Optional[PromptLoader] = None,
    ) -> None:
        super().__init__(
            agent_type="tech_branch",
            model=model,
            config=config or TechBranchAgentConfig(),
