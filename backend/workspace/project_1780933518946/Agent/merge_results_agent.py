...
@dataclass
class MergeResultsAgentConfig:
    """MergeResultsAgent 的运行参数。"""

    prompt_file: str = "merge_results_agent.md"
...
class MergeResultsAgent(BaseAgent):
    """
    负责"merge_results"的 agent。
    ...
    def __init__(
        ...
        config: Optional[MergeResultsAgentConfig] = None,
        prompt_loader: Optional[PromptLoader] = None,
    ) -> None:
        super().__init__(
            agent_type="merge_results",
            model=model,
            config=config or MergeResultsAgentConfig(),
