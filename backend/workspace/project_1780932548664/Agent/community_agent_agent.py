...
@dataclass
class CommunityAgentAgentConfig:
    """CommunityAgentAgent 的运行参数。"""

    prompt_file: str = "community_agent_agent.md"
...
class CommunityAgentAgent(BaseAgent):
    """
    负责"community_agent"的 agent。
    ...
    def __init__(
        ...
        config: Optional[CommunityAgentAgentConfig] = None,
        prompt_loader: Optional[PromptLoader] = None,
    ) -> None:
        super().__init__(
            agent_type="community_agent",
            model=model,
            config=config or CommunityAgentAgentConfig(),
